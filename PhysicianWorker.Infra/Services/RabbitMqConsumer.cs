        ...
        ILogger<RabbitMqConsumer> logger) : IMessageConsumer, IAsyncDisposable
{
    ...
    private const string QueueName = "transcript.ready.physician-worker";
    ...
    public Task StartConsumingAsync(CancellationToken ct)
    {
        ...
        {
            var messageType = nameof(TranscriptReadyMessage);
            ...
            try
            {
                ...
                var payload = JsonSerializer.Deserialize<TranscriptReadyMessage>(json)
